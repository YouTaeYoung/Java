...
/*
 메서드의 규칙
 -Jave에서는 main메서드는 무조건 public static void로
 	선언하기로 약속되어 있다
 -static으로 선언된 메서드는 static으로 선언된 메서드만
 	호출할 수 있다
 -메서드 호출후 반환값은 항상 호출한 위치로 반환된다. 이때
 	메서드는 메모리에서 소멸된다.
...
public class E01MethodBasic 
{
	...
	public static void main(String[] args) 
	{
		...
		/*
		 Jave에서 main() 메서드의 끝을 만나면 프로그램 자체가
		 종료된다.
		 */
