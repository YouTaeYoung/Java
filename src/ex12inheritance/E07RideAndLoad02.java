...
public class E07RideAndLoad02
{
	public static void main(String[] args)
	{
		...
		/*
		 정적메서드는  클레스명을 통해 호출한다. static의 기본규칙을
		 따르므로, 오버라이딩의 대사이 될수없다.
		 */
		DeChild.staticMethod();
		
		/////////////////////////////
		/*
		 부모타입의 참조변수로 자식객체를 잠조. 상속관계가 있으므로
		 가능함.
		 */
		
		System.out.println("Parent 형 참조변수로 Child객체 참조");
		DeParent parent = new DeChild("퇴계이황",30, "99학번");
