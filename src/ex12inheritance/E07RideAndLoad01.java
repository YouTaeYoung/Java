...
class A
{
	...
	public void lodMethod()
	{
		System.out.println("A의 lodMethod");
	}
}
class B extends A
{
...
class C extends B
{
	...
	/*
	 lodeMethod()는 오버로딩 처리된 메서드로 상위클래스에
	 정의된 메서드와 매개변수의 갯수, 타입이 서로 다르다.
	 */
	public void lodeMethod(double num)
	{
...
public class E07RideAndLoad01
{
	public static void main(String[] args)
	{
		...
		ref1.lodMethod();
		//ref1.lodMethod(1);=>B클래스 영역은 접근 불가
		//ref1.lodMethod(1.1);=>C클래스 영역은 접근 불가
		
		/////////////////////////////////////////////////////////
		
		//부모 참조변수로 자식 객체를 참조 할 수 있다.
		A refNnum1 = new B(); //가능
		A refNnum2 = new C(); //가능
		B refNnum3 = new C(); //가능
		...
		/*
		 위에서 에러가 난 부분은 아래처럼 다운케스팅(강제형변환) 하면
