 ...
 */
class NotebookcComputer extends Computer
{
	 ...
	 */
	public NotebookcComputer(String name , int initCharge)
	{
		/*
...
class TabletNotebook extends NotebookcComputer
{
	//테블릿을 사용하기 위한 펜슬을 표현
	String registPencil;
	//생성자
...
public class E04ISAInheritance
{
	...
	{
		NotebookcComputer noteBook = 
				new NotebookcComputer("공유", 5);
