...
class Friend
{
	...
	/*
	 간략정보를 출력하는 용도의 멤버메서드로 실행부가 없는
	 상태로 정의한다. 해동 프로그램에서는 오버라이딩의 목적으로만
	 사용된다.
	 */
...
/*
 해당 프로그램에서 기능을 담당하는 클래스를 핸들러 혹은 메니저
 클래스라고 한다. 
 */
class FriendInfoHandler
{
	...
	/*
	 ...
	 3.정보 출력시 배열에  입력된 객체수만큼 반복하면서 각 욧 ㅗ를 통해
	 	멤버메서드를 호출한다.
