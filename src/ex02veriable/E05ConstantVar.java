...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		/*
		 ...
		 -상수는 딱 한번만 최기화되고, 중간에 값을 변경하면 에러발생됨
		...
		//PI = 3.141592; // 에러발생됨. 상수는 한번 초기화하면 변결불가능.
		
		//상수는 초기화되지 않은 상태에서 출력하면 에러발생됨.
		final String NICK_NAME;
		//System.out.println("우리는 "+ NICK_NAME); 에러남 (상수를 초기화 하지않아서)
		NICK_NAME = "코스모";
		...
		/*
		 ...
		 코드로 작성되었다. 만약 다른 개발자가 해당코드를 본다면 확인절차를
		 거쳐야 할것이다.
		 */
		computer = 1;
		user = 3;
