...
public class Ex04HashSet1
{
	public static void main(String[] args)
	{
		...
		//다양한 객체 생성 
		String strObjet1 = "JAVA";
		String strObjet2 = new String("KOSMO99기");
		Date dateObjet = new Date();
		...
		객체저장
			...
			반환된다.
		 */
		System.out.println(set.add(strObjet1));
		set.add(strObjet2);
		set.add(dateObjet);
		set.add(number);
		set.add(teacher);
		 ...
		 */
		System.out.println(set.add(strObjet2) ? "저장성공" : "저장실패");
		 ...
		 */
		System.out.println(set.contains(strObjet1) ? "strObjet1있다" : "strObjet1 없다");
		...
		/*
		 객체 삭제
		 	...
		 	삭제할 수 있다.
		 */
		System.out.println(set.remove(strObjet2) ? "strObjet2삭제성공" : "strObjet2삭제실패");
