...
public class Ex05HashMapMain
{
	...
	public static void main(String[] args)
	{
		...
		int number = 20;
		//map.put("age", number); =>value타입이 맞지않아 에러발생
...
//////////////////////////////////////////////////////////////////////////
		...
		/*
		 	...
		 	※Map계열의 컬렉션은 처음부터개선된for문을 사용하는것은
		 	불가능하다. 아래처럼 Key값을 먼저 얻어온  후 사용해야한다.
		 */
		Set<String> keys = map.keySet();
		System.out.println("[확장for문적용]");
		for(String key : keys)
		{
		 ...
		 */
		System.out.println(map.containsKey("name")? "name키 값있다" : "name키값없다.");
		System.out.println(map.containsKey("account") ? "account키값있다" : "acccount키 값없다.");
		System.out.println(map.containsValue("남자") ? "남자 있다 " : "남자 없다");
		System.out.println(map.containsValue("여자") ? "여자 있다 " : "여자 없다");
		
		/*
		 삭제 : key 값을 통해 삭제하고 , 삭제되면 해당 value가 반환된다.
		 */
		...
		/*
			 전체삭제 : removerAll()은 없음 , clear()만 사용가능함.
		 */
		map.clear();
