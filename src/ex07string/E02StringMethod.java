	...
	{ 
		...
		/*
		 14] substring()
		 	...
		 	반환해준다.
		 	사용1 : substring(인덱스) => 이경우 인덱스 부터 끝까지 짤라낸다.
		...
		int begingIndex = filename.lastIndexOf(".") + 1;
		System.out.println("파일의 확장자는 : " + filename.substring(begingIndex));
		...
		System.out.println("### codePonintAt() ###");
